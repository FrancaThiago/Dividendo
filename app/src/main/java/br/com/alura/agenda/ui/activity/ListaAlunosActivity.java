...
public class ListaAlunosActivity extends AppCompatActivity {
    ...
    private void configuraFabCompras() {
        FloatingActionButton botaoCompras = findViewById(R.id.activity_lista_alunos_fab_compras);
        botaoCompras.setOnClickListener(view -> abreListaCompras());
    }
